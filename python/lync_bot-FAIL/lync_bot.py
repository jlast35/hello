...
sip_domain = "digecor.com"
username = "jason.anderson@digecor.com"
...
#    
discover_url = "http://lyncdiscover.{0}/".format(sip_domain)
...
print r2.headers['www-authenticate']
...
#this will always error out because lync does not support password authentication for online use
#something like "unsupported_grant_type"
#...which makes the rest of this code useless...
